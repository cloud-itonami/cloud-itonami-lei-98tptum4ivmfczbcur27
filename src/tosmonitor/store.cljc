(ns tosmonitor.store
  ...
  This repo archives exactly ONE company (Enbridge Inc., LEI
  98TPTUM4IVMFCZBCUR27) -- unlike `commitledger.store`'s multi-application
...
(def ^:private demo-full-text
  "Terms of Use\nThis website is provided by Enbridge Inc. (\"Enbridge\") for informational purposes about our liquids pipelines, gas transmission, gas utilities, and renewable energy operations. By accessing this website you agree to these Terms of Use, which Enbridge may revise at any time without notice. These Terms of Use are governed by the laws of the Province of Alberta and the federal laws of Canada applicable therein.")

(defn demo-baseline []
  {:full-text    demo-full-text
   :source-url   "https://www.enbridge.com/termsofuse"
