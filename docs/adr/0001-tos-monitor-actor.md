...
This repository archives the publicly published Terms of Use of Enbridge
Inc., per ADR-2607110300 -- a read-only reference archive. As part of a
fifth 10-repo validation batch extending the
...
- **Company**: Enbridge Inc., LEI 98TPTUM4IVMFCZBCUR27, website
  `https://www.enbridge.com`.
- **Baseline provenance** (real, from this repo's own `80-data/public/
  tos.journal.edn`): source-url `https://www.enbridge.com/termsofuse`,
